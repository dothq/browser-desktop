...
const DOT_MIGRATION_VERSION_PREF = "dot.migration.version";
...
class BrowserCustomisableUI {
    ...
    */
    ...
    public widgets: Map<string, CustomisableUIItem> = new Map();
    public targets: Map<string, CustomisableUITarget> = new Map();
    ...
    */
    ...
    public log = (...args: any) => this.console.log(...args);
    public warn = (...args: any) => this.console.warn(...args);

    public setMigrationVersion() {
        this.browser.preferences.unlock(DOT_MIGRATION_VERSION_PREF);
        
        const value = this.browser.preferences.get(DOT_MIGRATION_VERSION_PREF);
        ...
        this.browser.preferences.lock(DOT_MIGRATION_VERSION_PREF);
    }
    ...
    */
    public async init() {
        ...
        this.log(`Current UI version: ${this.currentUiVersion}`);

        this.targets.set("titlebar", new BrowserTitlebar());

        for(const [targetId, widgets] of Object.entries(this.defaultLayout)) {
            ...
            if(target) {
                ...
                throw new Error(`Target with ID '${targetId}' was not registered.`);
            }
        }
    }
