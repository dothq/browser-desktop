...
export const Button = ({ label, icon, primary, danger, style, onClick, noFocus }: { label?: string, icon?: string, primary?: boolean, danger?: boolean, style?: any, onClick?: any, noFocus?: boolean }) => {
    return (
        ...
        `.trim()} style={style} onClick={onClick}>
            {icon && <i
