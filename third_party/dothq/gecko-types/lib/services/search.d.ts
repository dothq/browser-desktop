...
export interface ServicesSearch {
     ...
     */
    addPolicyEngine(details: OpenSearchEngine): Promise<any>;
     ...
     *        {suggest_url} The suggestion url for the engine.
     */
    updatePolicyEngine(details: OpenSearchEngine): Promise<any>;
     ...
     *          exist.
     */
    getEngineByAlias(alias: string): Promise<any | null>;
     ...
     *          exist.
     */
    getEngineByName(aEngineName: string): any;
     ...
     *         hidden.
     */
    moveEngine(engine: any, newIndex: number): Promise<any>;
     ...
     */
    removeEngine(engine: any): Promise<any>;
     ...
     */
    readonly appPrivateDefaultEngine: any;
    ...
    setDefault(engine: any): Promise<any>;

    /**
     * The currently active search engine for private browsing mode.
     * @see defaultEngine.
     */
    defaultPrivateEngine: any;

    getDefaultPrivate(): Promise<any>;
    setDefaultPrivate(engine: any): Promise<any>;
