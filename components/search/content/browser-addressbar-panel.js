...
// leaking to window scope.
{
	...
	class MozBrowserPopup extends MozElements.MozElementMixin(XULPopupElement) {
		constructor() {
			super();
       ...
       `;
		...
		get scrollBox() {
			if (!this._scrollBox) {
				this._scrollBox =
					this.shadowRoot.querySelector("arrowscrollbox");
			}
	...
	customElements.define("abpopup", MozBrowserPopup);

	MozElements.MozBrowserPopup = MozBrowserPopup;
}
