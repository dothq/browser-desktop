...
class BrowserPanelArea extends BrowserCustomizableArea {
	...
	/**
	 * Fired when the area's physical bounds are changed
	 */
	_onAreaResized() {
		const bounds = this.getBoundingClientRect();

		this.setAttribute("width", bounds.width + "px");
		this.setAttribute("height", bounds.height + "px");
	}
