...
export class nsBrowserAccess {
    ...
    createContentWindow(
        ...
        console.log("createContentWindow", uri, openWindowInfo, where, flags, triggeringPrincipal, csp)
    ...
    getContentWindowOrOpenURI(
        ...
        if (flags & OPEN_NO_REFERRER) {
            ...
            referrerInfo = new lazy.ReferrerInfo(
                ...
                true, /* sendReferrer */
                Services.io.newURI(openWindowInfo.parent.window.location.href) /* originalReferrer */
            );
        } else {
            referrerInfo = new lazy.ReferrerInfo(
                Ci.nsIReferrerInfo.EMPTY,
        ...
        if (
            ...
            // current one.
            if (!this._win.gDot.tabs._isWebContentsBrowserElement(this._win.gDot.tabs.selectedTab.webContents)) {
                where = OPEN_NEWTAB;
            }
        }
        ...
        switch (where) {
            ...
            default:
                ...
                browsingContext = /** @type {ChromeBrowser} */ (this._win.gDot.tabs.selectedTab.webContents).browsingContext;
                ...
                if (uri) {
                    ...
                    /** @type {ChromeBrowser} */ (this._win.gDot.tabs.selectedTab.webContents).fixupAndLoadURIString(uri.spec, {
                        triggeringPrincipal,
                        csp,
                        loadFlags,
                        referrerInfo,
